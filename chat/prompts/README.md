...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `3_gen_art/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_evaluation_1.md` — 17 prompts
  ...
  - round_2
    ...
    - `3_gen_art/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_dataset_1.md` — 18 prompts
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_evaluation_1.md` — 16 prompts
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 8 prompts
    - `chat/prompts/2_test_idea/round_2/4_gen_paper_text.md` — 17 prompts
    - `chat/prompts/2_test_idea/round_2/5_review_paper.md` — 6 prompts
    - `chat/prompts/2_test_idea/round_2/6_upd_hypo.md` — 6 prompts
